...
export default function AboutSection() {
  return (
    <section id="About" className=" w-full px-5 md:min-h-screen mb-10 flex flex-col gap-16 ">
      ...
      <div className="w-full flex justify-start">
        <div className="md:max-w-[50%] md:text-2xl">
          <SubIntroText className="text-white">
            ...
            education through immersive reality. We believe in the power of
            Virtual Reality (VR), Augmented Reality (AR), and Mixed Reality (MR)
            to make healthcare learning safer, smarter, and more human-centered.
          </SubIntroText>
        </div>
      </div>
