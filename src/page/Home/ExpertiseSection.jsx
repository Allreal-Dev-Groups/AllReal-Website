    ...
    <section className="w-full px-5 md:min-h-screen mb-10 flex flex-col gap-16 overflow-hidden">
      ...
      <div className="w-full flex flex-col gap-5">
        <ImageBox
          ...
          text="We specialize in developing gamified healthcare applications designed to train, engage,
and assess users effectively.
Our VR/MR applications covering CPR, NRP, dementia care and first aid
transform critical training into interactive simulations that improve skill retention and real-world
readiness."
        />
        <ImageBox
          image="/images/Banner2.jpg"
          title="Experience Lab Research, Prototyping & Technical Partnership"
          text="Our Experience Lab partners with hospitals and universities to research,
design, and prototype immersive medical simulations.
We serve as a technical partner for institutions seeking innovation in AR/VR
healthcare tools, clinical training modules, and simulation-based education systems."
          reverse={true}
        />
        <ImageBox
          image="/images/Banner3.jpg"
          title="Medical Simulations for Consumer Branding"
          text="We help healthcare organizations visualize their impact through VR storytelling. By creating
lifelike medical simulations and mixed reality demonstrations, we help brands
showcase their innovations more effectively for exhibitions, awareness campaigns, product
launches, or training showcases."
        />
      </div>
    </section>
  );
