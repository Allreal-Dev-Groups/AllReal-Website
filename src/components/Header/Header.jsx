      ...
      <header className="fixed top-0 left-0 right-0 z-100 flex items-center justify-between px-5 md:px-[6%] py-3 md:py-5 h-[70px] backdrop-blur-md shadow-lg">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col leading-tight ">
            <h1 className="font-brandFont text-[#8636ff] text-xl md:text-4xl font-bold leading-5 ">
              allreal
            </h1>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2 cursor-pointer">
          ...
          <button
            ...
            className="cursor-hover  w-[25px] md:w-10 h-[25px] md:h-10 bg-[#4d13db] backdrop-blur-sm rounded-3xl flex items-center justify-center cursor-pointer transition-transform duration-300 ease-in-out hover:scale-105"
          >
            <svg
