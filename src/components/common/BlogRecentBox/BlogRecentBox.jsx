...
export default function BlogRecentBox({ date, title, description, image="/assets/images/sampleblogimg.jpg", nav="/", tags = [] }) {
  ...
  return (
    ...
    >
      ...
      {/* Content Section */}
      <div className="flex flex-col justify-between p-4 md:p-6 rounded-2xl w-full">
        <h2 className="text-sm md:text-xl text-[#dfcce2] font-medium">{date}</h2>
        <a href="/blog/somthing" className="pointer-events-auto">
        <h1 className="text-2xl md:text-4xl lg:text-7xl text-[#dfcce2] font-bold mt-2 md:mt-4 pointer-events-auto">
          {title}
        </h1>
