...
import { InfiniteWordScroller } from "@/components/custom";
...
export default function TextScrollSection() {
  ...
  useEffect(() => {
    ...
    ScrollTrigger.matchMedia({
      ...
      "(max-width: 767px)": () => {
        gsap.fromTo(
          el,
          { y: -200, width: "30%", borderRadius: "100rem" },
          {
            y: 10,
            width: "60%",
            borderRadius: "1rem",
  ...
  return (
    <section className="h-[100px] md:min-h-screen flex justify-center items-center">
